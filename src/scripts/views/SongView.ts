...
class SongView {
    ...
    constructor() {
        this.songsListElement = document.querySelector('.songs__list')! as HTMLElement
        this.songEle = '.song'
        this.removeBtn = '.song__remove'
        this.searchInput = document.querySelector('#search-song-input')! as HTMLElement
    }
    ...
    renderSong = (song: SongModel): void => {
        this.songsListElement.innerHTML += 
            Template.song.getSongTemplate(song)
    }
}
